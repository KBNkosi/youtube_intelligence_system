...
| R-007 | Risk | Existing commercial products may already solve the problem sufficiently | Open | High |
| R-008 | Assumption | SEM's creator/channel data can support a useful experiment | Unverified | High |